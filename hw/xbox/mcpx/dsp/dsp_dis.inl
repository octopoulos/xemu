...
static const char* disasm_opcodes_alu[256] = {
	/* 0x00 - 0x3f */
	"move", "tfr b,a", "addr b,a", "tst a", "undefined", "cmp b,a", "subr b,a", "cmpm b,a", "undefined", "tfr a,b",
	"addr a,b", "tst b", "undefined", "cmp a,b", "subr a,b", "cmpm a,b", "add b,a", "rnd a", "addl b,a", "clr a",
	"sub b,a", "undefined", "subl b,a", "not a", "add a,b", "rnd b", "addl a,b", "clr b", "sub a,b", "max a,b",
	"subl a,b", "not b", "add x,a", "adc x,a", "asr a", "lsr a", "sub x,a", "sbc x,a", "abs a", "ror a", "add x,b",
	"adc x,b", "asr b", "lsr b", "sub x,b", "sbc x,b", "abs b", "ror b", "add y,a", "adc y,a", "asl a", "lsl a",
	"sub y,a", "sbc y,a", "neg a", "rol a", "add y,b", "adc y,b", "asl b", "lsl b", "sub y,b", "sbc y,b", "neg b",
	"rol b",

	/* 0x40 - 0x7f */
	"add x0,a", "tfr x0,a", "or x0,a", "eor x0,a", "sub x0,a", "cmp x0,a", "and x0,a", "cmpm x0,a", "add x0,b",
	"tfr x0,b", "or x0,b", "eor x0,b", "sub x0,b", "cmp x0,b", "and x0,b", "cmpm x0,b", "add y0,a", "tfr y0,a",
	"or y0,a", "eor y0,a", "sub y0,a", "cmp y0,a", "and y0,a", "cmpm y0,a", "add y0,b", "tfr y0,b", "or y0,b",
	"eor y0,b", "sub y0,b", "cmp y0,b", "and y0,b", "cmpm y0,b", "add x1,a", "tfr x1,a", "or x1,a", "eor x1,a",
	"sub x1,a", "cmp x1,a", "and x1,a", "cmpm x1,a", "add x1,b", "tfr x1,b", "or x1,b", "eor x1,b", "sub x1,b",
	"cmp x1,b", "and x1,b", "cmpm x1,b", "add y1,a", "tfr y1,a", "or y1,a", "eor y1,a", "sub y1,a", "cmp y1,a",
	"and y1,a", "cmpm y1,a", "add y1,b", "tfr y1,b", "or y1,b", "eor y1,b", "sub y1,b", "cmp y1,b", "and y1,b",
	"cmpm y1,b",

	/* 0x80 - 0xbf */
	"mpy +x0,x0,a", "mpyr +x0,x0,a", "mac +x0,x0,a", "macr +x0,x0,a", "mpy -x0,x0,a", "mpyr -x0,x0,a", "mac -x0,x0,a",
	"macr -x0,x0,a", "mpy +x0,x0,b", "mpyr +x0,x0,b", "mac +x0,x0,b", "macr +x0,x0,b", "mpy -x0,x0,b", "mpyr -x0,x0,b",
	"mac -x0,x0,b", "macr -x0,x0,b", "mpy +y0,y0,a", "mpyr +y0,y0,a", "mac +y0,y0,a", "macr +y0,y0,a", "mpy -y0,y0,a",
	"mpyr -y0,y0,a", "mac -y0,y0,a", "macr -y0,y0,a", "mpy +y0,y0,b", "mpyr +y0,y0,b", "mac +y0,y0,b", "macr +y0,y0,b",
	"mpy -y0,y0,b", "mpyr -y0,y0,b", "mac -y0,y0,b", "macr -y0,y0,b", "mpy +x1,x0,a", "mpyr +x1,x0,a", "mac +x1,x0,a",
	"macr +x1,x0,a", "mpy -x1,x0,a", "mpyr -x1,x0,a", "mac -x1,x0,a", "macr -x1,x0,a", "mpy +x1,x0,b", "mpyr +x1,x0,b",
	"mac +x1,x0,b", "macr +x1,x0,b", "mpy -x1,x0,b", "mpyr -x1,x0,b", "mac -x1,x0,b", "macr -x1,x0,b", "mpy +y1,y0,a",
	"mpyr +y1,y0,a", "mac +y1,y0,a", "macr +y1,y0,a", "mpy -y1,y0,a", "mpyr -y1,y0,a", "mac -y1,y0,a", "macr -y1,y0,a",
	"mpy +y1,y0,b", "mpyr +y1,y0,b", "mac +y1,y0,b", "macr +y1,y0,b", "mpy -y1,y0,b", "mpyr -y1,y0,b", "mac -y1,y0,b",
	"macr -y1,y0,b",

	/* 0xc0 - 0xff */
	"mpy +x0,y1,a", "mpyr +x0,y1,a", "mac +x0,y1,a", "macr +x0,y1,a", "mpy -x0,y1,a", "mpyr -x0,y1,a", "mac -x0,y1,a",
	"macr -x0,y1,a", "mpy +x0,y1,b", "mpyr +x0,y1,b", "mac +x0,y1,b", "macr +x0,y1,b", "mpy -x0,y1,b", "mpyr -x0,y1,b",
	"mac -x0,y1,b", "macr -x0,y1,b", "mpy +y0,x0,a", "mpyr +y0,x0,a", "mac +y0,x0,a", "macr +y0,x0,a", "mpy -y0,x0,a",
	"mpyr -y0,x0,a", "mac -y0,x0,a", "macr -y0,x0,a", "mpy +y0,x0,b", "mpyr +y0,x0,b", "mac +y0,x0,b", "macr +y0,x0,b",
	"mpy -y0,x0,b", "mpyr -y0,x0,b", "mac -y0,x0,b", "macr -y0,x0,b", "mpy +x1,y0,a", "mpyr +x1,y0,a", "mac +x1,y0,a",
	"macr +x1,y0,a", "mpy -x1,y0,a", "mpyr -x1,y0,a", "mac -x1,y0,a", "macr -x1,y0,a", "mpy +x1,y0,b", "mpyr +x1,y0,b",
	"mac +x1,y0,b", "macr +x1,y0,b", "mpy -x1,y0,b", "mpyr -x1,y0,b", "mac -x1,y0,b", "macr -x1,y0,b", "mpy +y1,x1,a",
	"mpyr +y1,x1,a", "mac +y1,x1,a", "macr +y1,x1,a", "mpy -y1,x1,a", "mpyr -y1,x1,a", "mac -y1,x1,a", "macr -y1,x1,a",
	"mpy +y1,x1,b", "mpyr +y1,x1,b", "mac +y1,x1,b", "macr +y1,x1,b", "mpy -y1,x1,b", "mpyr -y1,x1,b", "mac -y1,x1,b",
	"macr -y1,x1,b"
};
...
static const dis_func_t disasm_opcodes_parmove[16] = {
	dis_pm_0, dis_pm_1, dis_pm_2, dis_pm_2, dis_pm_4, dis_pm_4, dis_pm_4, dis_pm_4,
	dis_pm_8, dis_pm_8, dis_pm_8, dis_pm_8, dis_pm_8, dis_pm_8, dis_pm_8, dis_pm_8,
};

static const char* registers_lmove[8] = { "a10", "b10", "x", "y", "a", "b", "ab", "ba" };
...
static void dis_asl_imm(dsp_core_t* dsp)
{
	...
	sprintf(
		dsp->disasm_str_instr, "asl #$%02x,%s,%s", ii, registers_name[S ? DSP_REG_B : DSP_REG_A],
...
static void dis_lsl_imm(dsp_core_t* dsp)
{
	...
	sprintf(dsp->disasm_str_instr, "lsl #$%02x, %s", ii, registers_name[D ? DSP_REG_B : DSP_REG_A]);
}
...
static void dis_asr_imm(dsp_core_t* dsp)
{
	...
	uint32_t ii = (dsp->disasm_cur_inst >> 1) & BITMASK(6);
	sprintf(
		dsp->disasm_str_instr, "asr #$%02x,%s,%s", ii, registers_name[S ? DSP_REG_B : DSP_REG_A],
		registers_name[D ? DSP_REG_B : DSP_REG_A]);
}
...
static void dis_bcc_long(dsp_core_t* dsp)
{
	...
	sprintf(dsp->disasm_str_instr, "b%s p:$%06x", cond_name, (dsp->pc + xxxx) & BITMASK(24));
}
...
static void dis_bcc_imm(dsp_core_t* dsp)
{
	...
	uint32_t xxx = (dsp->disasm_cur_inst & BITMASK(5)) + ((dsp->disasm_cur_inst & (BITMASK(4) << 6)) >> 1);

	dis_calc_cc(dsp, cc_code, cond_name);

	sprintf(dsp->disasm_str_instr, "b%s p:$%06x", cond_name, (dsp->pc + dsp_signextend(9, xxx)) & BITMASK(24));
}
...
static void dis_bra_long(dsp_core_t* dsp)
{
	uint32_t xxxx = read_memory_p(dsp, dsp->pc + 1);
	dsp->disasm_cur_inst_len++;
	sprintf(dsp->disasm_str_instr, "bra p:$%06x", (dsp->pc + xxxx) & BITMASK(24));
}

static void dis_bra_imm(dsp_core_t* dsp)
{
	uint32_t xxx = (dsp->disasm_cur_inst & BITMASK(5)) + ((dsp->disasm_cur_inst & (BITMASK(4) << 6)) >> 1);
	sprintf(dsp->disasm_str_instr, "bra p:$%04x", (dsp->pc + dsp_signextend(9, xxx)) & BITMASK(24));
}
...
static void dis_brclr_pp(dsp_core_t* dsp)
{
	...
	sprintf(dsp->disasm_str_instr, "brclr #%d,%s,p:$%06x", numbit, name, (dsp->pc + xxxx) & BITMASK(24));
}
...
static void dis_brclr_reg(dsp_core_t* dsp)
{
	...
	sprintf(
		dsp->disasm_str_instr, "brclr #%d,%s,p:$%04x", numbit, registers_name[value], (dsp->pc + xxxx) & BITMASK(24));
}
...
static void dis_brset_pp(dsp_core_t* dsp)
{
	...
	sprintf(dsp->disasm_str_instr, "brset #%d,%s,p:$%06x", numbit, name, (dsp->pc + xxxx) & BITMASK(24));
}
...
static void dis_brset_reg(dsp_core_t* dsp)
{
	...
	sprintf(
		dsp->disasm_str_instr, "brset #%d,%s,p:$%04x", numbit, registers_name[value], (dsp->pc + xxxx) & BITMASK(24));
}
...
static void dis_bsr_long(dsp_core_t* dsp)
{
	dsp->disasm_cur_inst_len++;
	uint32_t xxxx = read_memory_p(dsp, dsp->pc + 1);
	sprintf(dsp->disasm_str_instr, "bsr p:$%06x", (dsp->pc + xxxx) & BITMASK(24));
}

static void dis_bsr_imm(dsp_core_t* dsp)
{
	uint32_t xxx = (dsp->disasm_cur_inst & BITMASK(5)) + ((dsp->disasm_cur_inst & (BITMASK(4) << 6)) >> 1);
	sprintf(dsp->disasm_str_instr, "bsr p:$%04x", (dsp->pc + dsp_signextend(9, xxx)) & BITMASK(24));
}
...
static void dis_cmp_imm(dsp_core_t* dsp)
{
	...
	sprintf(dsp->disasm_str_instr, "cmp #$%02x,%s", xx, registers_name[d ? DSP_REG_B : DSP_REG_A]);
}
...
static void dis_cmp_long(dsp_core_t* dsp)
{
	...
	uint32_t d = (dsp->disasm_cur_inst >> 3) & 1;
	sprintf(dsp->disasm_str_instr, "cmp #$%06x,%s", xxxx, registers_name[d ? DSP_REG_B : DSP_REG_A]);
}
...
static void dis_do_aa(dsp_core_t* dsp)
{
	...
	sprintf(dsp->disasm_str_instr, "do %s,p:$%04x", name, read_memory_p(dsp, dsp->pc + 1));
}
...
static void dis_do_imm(dsp_core_t* dsp)
{
	...
	sprintf(
		dsp->disasm_str_instr, "do #$%04x,p:$%04x",
...
static void dis_do_reg(dsp_core_t* dsp)
{
	...
	sprintf(
		dsp->disasm_str_instr, "do %s,p:$%04x", registers_name[(dsp->disasm_cur_inst >> 8) & BITMASK(6)],
		read_memory_p(dsp, dsp->pc + 1));
}
...
static void dis_dor_imm(dsp_core_t* dsp)
{
	...
	sprintf(dsp->disasm_str_instr, "dor #$%04x,p:$%04x", xxx, (dsp->pc + addr) & BITMASK(24));
}
...
static void dis_dor_reg(dsp_core_t* dsp)
{
	...
	sprintf(dsp->disasm_str_instr, "dor %s,p:$%04x", registers_name[numreg], (dsp->pc + addr) & BITMASK(24));
}
...
static void dis_jclr_aa(dsp_core_t* dsp)
{
	...
	sprintf(dsp->disasm_str_instr, "jclr #%d,%s,p:$%04x", numbit, srcname, read_memory_p(dsp, dsp->pc + 1));
}
...
static void dis_jclr_reg(dsp_core_t* dsp)
{
	...
	sprintf(
		dsp->disasm_str_instr, "jclr #%d,%s,p:$%04x", numbit, registers_name[value], read_memory_p(dsp, dsp->pc + 1));
}
...
static void dis_jsclr_aa(dsp_core_t* dsp)
{
	...
	sprintf(dsp->disasm_str_instr, "jsclr #%d,%s,p:$%04x", numbit, srcname, read_memory_p(dsp, dsp->pc + 1));
}
...
static void dis_jsclr_reg(dsp_core_t* dsp)
{
	...
	sprintf(
		dsp->disasm_str_instr, "jsclr #%d,%s,p:$%04x", numbit, registers_name[value], read_memory_p(dsp, dsp->pc + 1));
}
...
static void dis_jset_aa(dsp_core_t* dsp)
{
	...
	sprintf(dsp->disasm_str_instr, "jset #%d,%s,p:$%04x", numbit, srcname, read_memory_p(dsp, dsp->pc + 1));
}
...
static void dis_jset_reg(dsp_core_t* dsp)
{
	...
	sprintf(
		dsp->disasm_str_instr, "jset #%d,%s,p:$%04x", numbit, registers_name[value], read_memory_p(dsp, dsp->pc + 1));
}
...
static void dis_jsset_aa(dsp_core_t* dsp)
{
	...
	sprintf(dsp->disasm_str_instr, "jsset #%d,%s,p:$%04x", numbit, srcname, read_memory_p(dsp, dsp->pc + 1));
}
...
static void dis_jsset_reg(dsp_core_t* dsp)
{
	...
	sprintf(
		dsp->disasm_str_instr, "jsset #%d,%s,p:$%04x", numbit, registers_name[value], read_memory_p(dsp, dsp->pc + 1));
}
...
{
	uint32_t aa = ((dsp->disasm_cur_inst >> 4) & BITMASK(4)) + (((dsp->disasm_cur_inst >> 11) & BITMASK(3)) << 4);
	...
	{
		sprintf(dsp->disasm_str_instr, "lua (r%d + %d),n%d", addrreg, aa_s, dstreg);
	}
	else
	{
		sprintf(dsp->disasm_str_instr, "lua (r%d + %d),r%d", addrreg, aa_s, dstreg);
	}
}
...
static void dis_move_x_long(dsp_core_t* dsp)
{
	...
	if (W)
	{
		sprintf(dsp->disasm_str_instr, "move x:(%s + %d), %s", registers_name[offreg], xxxx_s, registers_name[numreg]);
	}
	else
	{
		sprintf(dsp->disasm_str_instr, "move %s, x:(%s + %d)", registers_name[numreg], registers_name[offreg], xxxx_s);
	}
}
...
static void dis_move_xy_imm(dsp_core_t* dsp, int space)
{
	...
	uint32_t xxx = (((dsp->disasm_cur_inst >> 11) & BITMASK(6)) << 1) + ((dsp->disasm_cur_inst >> 6) & 1);
	uint32_t offreg = DSP_REG_R0 + ((dsp->disasm_cur_inst >> 8) & BITMASK(3));
	uint32_t numreg = dsp->disasm_cur_inst & BITMASK(4);
	...
	{
		sprintf(
			dsp->disasm_str_instr, "move %c:(%s + %d), %s", space_c, registers_name[offreg], xxx_s,
			registers_name[numreg]);
	}
	else
	{
		sprintf(
			dsp->disasm_str_instr, "move %s, %c:(%s + %d)", registers_name[numreg], space_c, registers_name[offreg],
			xxx_s);
	}
}
...
static void dis_mpyi(dsp_core_t* dsp)
{
	...
	sprintf(
		dsp->disasm_str_instr, "mpyi %s#$%06x,%s,%s", k ? "-" : "+", xxxx, registers_name[srcreg],
		registers_name[destreg]);
}
...
static void dis_sub_imm(dsp_core_t* dsp)
{
	uint32_t xx = (dsp->disasm_cur_inst >> 8) & BITMASK(6);
	uint32_t d = (dsp->disasm_cur_inst >> 3) & 1;
	sprintf(dsp->disasm_str_instr, "sub #$%02x,%s", xx, registers_name[d ? DSP_REG_B : DSP_REG_A]);
}
...
static void dis_sub_long(dsp_core_t* dsp)
{
	...
	dsp->disasm_cur_inst_len++;
	uint32_t d = (dsp->disasm_cur_inst >> 3) & 1;
	sprintf(dsp->disasm_str_instr, "sub #$%06x,%s", xxxx, registers_name[d ? DSP_REG_B : DSP_REG_A]);
}
...
static void dis_tcc(dsp_core_t* dsp)
{
	...
	if (dsp->disasm_cur_inst & (1 << 16))
	{
		...
		sprintf(
			dsp->disasm_str_instr, "t%s %s,%s %s,%s", ccname, registers_name[src1reg], registers_name[dst1reg],
			registers_name[src2reg], registers_name[dst2reg]);
	}
	else
	{
		sprintf(dsp->disasm_str_instr, "t%s %s,%s", ccname, registers_name[src1reg], registers_name[dst1reg]);
	}
}
...
static void dis_pm_0(dsp_core_t* dsp)
{
	...
	*/
	...
	sprintf(
		dsp->disasm_parallelmove_name, "%s,%s:%s %s,%s", registers_name[numreg1], space_name, addr_name,
	...
	*/
	...
	if (memspace == DSP_SPACE_Y)
	{
		...
		case 0:
			...
			break;
		case 1:
			s2reg = d2reg = DSP_REG_Y1;
			break;
		case 2:
			s2reg = d2reg = DSP_REG_A;
			break;
		case 3:
			s2reg = d2reg = DSP_REG_B;
			break;
		}
		...
		if (write_flag)
		{
			...
			{
				sprintf(
					dsp->disasm_parallelmove_name, "%s,%s #%s,%s", registers_name[s1reg], registers_name[d1reg],
					addr_name, registers_name[d2reg]);
			}
			else
			{
				sprintf(
					dsp->disasm_parallelmove_name, "%s,%s y:%s,%s", registers_name[s1reg], registers_name[d1reg],
					addr_name, registers_name[d2reg]);
			}
		}
		else
		{
			/* Read S2 */
			sprintf(
				dsp->disasm_parallelmove_name, "%s,%s %s,y:%s", registers_name[s1reg], registers_name[d1reg],
				registers_name[s2reg], addr_name);
		}
	}
	else
	{
		...
		case 0:
			...
			break;
		case 1:
			s1reg = d1reg = DSP_REG_X1;
			break;
		case 2:
			s1reg = d1reg = DSP_REG_A;
			break;
		case 3:
			s1reg = d1reg = DSP_REG_B;
			break;
		}
		...
		if (write_flag)
		{
			...
			{
				sprintf(
					dsp->disasm_parallelmove_name, "#%s,%s %s,%s", addr_name, registers_name[d1reg],
					registers_name[s2reg], registers_name[d2reg]);
			}
			else
			{
				sprintf(
					dsp->disasm_parallelmove_name, "x:%s,%s %s,%s", addr_name, registers_name[d1reg],
					registers_name[s2reg], registers_name[d2reg]);
			}
		}
		else
		{
			/* Read S1 */
			sprintf(
				dsp->disasm_parallelmove_name, "%s,x:%s %s,%s", registers_name[s1reg], addr_name, registers_name[s2reg],
...
static void dis_pm_2(dsp_core_t* dsp)
{
	...
	*/
	...
	sprintf(
		dsp->disasm_parallelmove_name, "#$%02x,%s", (dsp->disasm_cur_inst >> 8) & BITMASK(8), registers_name[numreg1]);
}
...
static void dis_pm_8(dsp_core_t* dsp)
{
	...
	*/
	...
	if (dsp->disasm_cur_inst & (1 << 15))
	{
		...
		{
			sprintf(
				dsp->disasm_parallelmove_name, "x:%s,%s y:%s,%s", addr1_name, registers_name[numreg1], addr2_name,
				registers_name[numreg2]);
		}
		else
		{
			sprintf(
				dsp->disasm_parallelmove_name, "x:%s,%s %s,y:%s", addr1_name, registers_name[numreg1],
				registers_name[numreg2], addr2_name);
		}
	}
	else
	{
		...
		{
			sprintf(
				dsp->disasm_parallelmove_name, "%s,x:%s y:%s,%s", registers_name[numreg1], addr1_name, addr2_name,
				registers_name[numreg2]);
		}
		else
		{
			sprintf(
				dsp->disasm_parallelmove_name, "%s,x:%s %s,y:%s", registers_name[numreg1], addr1_name,
				registers_name[numreg2], addr2_name);
		}
	}
}
