...
uint64_t pramdac_read(void* opaque, hwaddr addr, unsigned int size)
{
	...
	case NV_PRAMDAC_PLL_TEST_COUNTER:
		...
		r = NV_PRAMDAC_PLL_TEST_COUNTER_VPLL2_LOCK | NV_PRAMDAC_PLL_TEST_COUNTER_NVPLL_LOCK
			| NV_PRAMDAC_PLL_TEST_COUNTER_MPLL_LOCK | NV_PRAMDAC_PLL_TEST_COUNTER_VPLL_LOCK;
		break;
